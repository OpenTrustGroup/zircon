...
static bool smc_handle_request_normal_test(void) {
    BEGIN_TEST;
    ASSERT_TRUE(setup(), "setup");
...
static bool smc_read_and_set_result_test(void) {
    BEGIN_TEST;
    ASSERT_TRUE(setup(), "setup");
...
RUN_TEST(smc_handle_request_normal_test)
RUN_TEST(smc_read_and_set_result_test)
